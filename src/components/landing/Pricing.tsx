      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          {loading ? (
            ...
            prices.map((p: any) => (
              <div key={p.id} className={`p-8 rounded-lg ${p.recommended ? "bg-blue-100 border-2 border-blue-900" : "bg-gray-50 border border-gray-300"}`}>
                ...
                <div className="mb-6">
                  ...
                  <p className="text-sm text-gray-600">{p.frequency}</p>
                  {p.name === "Curso completo" && (
                    <p className="text-xs text-gray-600 mt-2">(o 9 cuotas de 140€)</p>
                  )}
                </div>
